#!/usr/bin/env python3
"""
Batch process all new simulation log files from logs/ and snaps/ subdirectories.
These files use a different naming convention: maxReads_X_accessRate_Y_dist_Z_TIMESTAMP.txt
"""
...
def generate_output_name(log_file, output_dir):
    ...
    Example: maxReads_100_accessRate_100_dist_Uniform_20251220_154011.txt
             -> maxReads_100_accessRate_100_dist_Uniform_20251220_154011_status.png
    """
    basename = os.path.basename(log_file)
    # Remove ".txt" suffix, add "_status.png"
    name = basename.replace(".txt", "_status.png")
    return os.path.join(output_dir, name)

def main():
    # Use subdirectories under input/
    logs_dir = "input/logs"
    snaps_dir = "input/snaps"
    output_dir = "output"
