#!/usr/bin/env python3
"""
Compare metrics across multiple approaches focusing on cluster size variations.
"""
...
def get_short_name(folder_name):
    ...
    name_map = {
        'triplets_clustered_random_small_cluster_expiration': 'Triplets Small Cluster',
        'triplets_clustered_random_big_cluster_expiration': 'Triplets Big Cluster',
        'tube_replication_small_cluster_expiration': 'Tube Repl Small Cluster',
        'tube_replication_big_cluster_expiration': 'Tube Repl Big Cluster',
...
def plot_folder_comparison(files_dict, config_name, output_dir):
    ...
    colors = {
        ...
        'triplets_clustered_random_big_cluster_expiration': 'tab:cyan',
        'tube_replication_small_cluster_expiration': 'tab:red',
        'tube_replication_big_cluster_expiration': 'tab:orange',
    ...
    # Overall title
    fig.suptitle(f'Cluster Size Comparison: {config_name}', 
    ...
    output_path = os.path.join(output_dir, f'cluster_comparison_{safe_config_name}.png')
...
def main():
    ...
    output_dir = '/Users/stephanie.schustermann/tesis/python_projects/output/snapshot_metrics/cluster_size_comparisons'
    ...
    folders = {
        ...
        'triplets_clustered_random_big_cluster_expiration': os.path.join(base_path, 'triplets_clustered_random_big_cluster_expiration'),
        'tube_replication_small_cluster_expiration': os.path.join(base_path, 'tube_replication_small_cluster_expiration'),
        'tube_replication_big_cluster_expiration': os.path.join(base_path, 'tube_replication_big_cluster_expiration'),
